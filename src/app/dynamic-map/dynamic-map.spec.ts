...
describe('DynamicMap', () => {
  ...
  describe('simpleGenerate', () => {
    ...
    it('should return a non-empty map', () => {
      ...
      const map = dynamicMap[gen](400, 600, 50, seed);
    ...
    it('should return the same maps from same test seeds', () => {
      ...
      for(const seed of testSeeds){
        const map1 = dynamicMap[gen](400, 600, 50, seed);
        const map2 = dynamicMap[gen](400, 600, 50, seed);
    ...
    it('should generate nodes within the boundary limit', () => {
      ...
      let map = dynamicMap[gen](400, 600, setLimit, seed);
      for(const m of map) {
      ...
      for (let x = 0; x < 10; x++) { //tests multiple times to check for out of bounds generations.
        map = dynamicMap[gen](400, 600, randomLimit, seed);
        for (const m of map) {
    ...
    it('should generate map with limited resources', () => {
      ...
      let map = dynamicMap[gen](400, 600, 50, seed);
      ...
      map = dynamicMap[gen](400, 600, 50, seed);
    ...
    it('should run validation on resource array', () => {
      ...
      dynamicMap['context'] = // eslint-disable-line @typescript-eslint/dot-notation
        new ShowMapComponent(null, null, null, null, null, null, null, new GeneratorSettingsService(), null, new NgbTooltipConfig(null));
